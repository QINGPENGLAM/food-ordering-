...
function displayItems(){
    ...
    var southIndian=  document.getElementById('Mexico');

    

    const americanData= foodItem.filter((item)=>item.category=='american');
    const japanData= foodItem.filter((item)=>item.category=='japan');
    const thaiData= foodItem.filter((item)=>item.category=='thai');
    const KoreanData= foodItem.filter((item)=>item.category=='Korean');
    const chineseData= foodItem.filter((item)=>item.category=='chinese');
    const southData= foodItem.filter((item)=>item.category=='Mexico');
